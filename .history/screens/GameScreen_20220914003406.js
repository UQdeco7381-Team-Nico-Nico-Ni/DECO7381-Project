...
return (
    <DraxProvider>
      ...
      <Image style={styles.image} source={{ uri: selectedGarbage.imageUrl }} />
      <Text style={styles.title}>{selectedGarbage.title}</Text>
      <GarbageDetails
        duration={selectedGarbage.duration}
        complexity={selectedGarbage.complexity}
        affordability={selectedGarbage.affordability}
        textStyle={styles.detailText}
      />
      <View style={styles.listOuterContainer}>
        <View style={styles.listContainer}>
          <Subtitle>Ingredients</Subtitle>
          <List data={selectedGarbage.ingredients} />
          <Subtitle>Steps</Subtitle>
          <List data={selectedGarbage.steps} />
        </View>
      </View>
    </ScrollView>
